...
//            - - - - - - - -
    ...
    [_GAME] = LAYOUT_elora_hlc(
     ...
     KC_B ,KC_G, KC_Z   ,  KC_X  ,   KC_C ,   KC_V , QK_REP,_______,     _______  , _______, _______,   _______ ,  _______ ,   _______ ,  _______ , _______,
    ...
    [_SYMBOLS] = LAYOUT_elora_hlc(
     _______    , _______   ,  _______    , LALT(KC_F4)   ,   _______    ,   _______ ,                                                 _______ ,  _______ ,  _______ ,   KC_LBRC ,  KC_RBRC , KC_HOME ,
        _______ , _______   ,  LALT(KC_LCTL)  ,    _______      ,   _______    ,   KC_F1 ,                                                 KC_EQL,   KC_KP_7,  KC_KP_8 ,   KC_KP_9 , LSG(KC_MINUS), KC_END,
